        ...
        <Card className="bg-transparent backdrop-blur-sm">
          <CardContent className="p-8">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-4 text-2xl font-semibold">Track Your Impact</h3>
            </div>
        ...
        <Card className="bg-transparent backdrop-blur-sm">
          <CardContent className="p-8">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-4 text-2xl font-semibold">Discover Green Routes</h3>
            </div>
            <p className="ml-14 text-sm">
        ...
        <Card className="bg-transparent backdrop-blur-sm">
          <CardContent className="p-8">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-4 text-2xl font-semibold">Earn Rewards</h3>
            </div>
            <p className="ml-14 text-sm">
        ...
        <Card className="bg-transparent backdrop-blur-sm">
          <CardContent className="p-8">
            <div className="flex items-center mb-4">
              ...
              <h3 className="ml-4 text-2xl font-semibold">Build Healthy Habits</h3>
            </div>
            <p className="ml-14 text-sm">
      ...
      <div className="text-center mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-xl font-medium mb-2">Track Your Journeys</h3>
            <p className="text-xs text-muted-foreground">Record walking, cycling, and public transit trips automatically or manually</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-xl font-medium mb-2">Complete Challenges</h3>
            <p className="text-xs text-muted-foreground">Earn points and achievements by meeting eco-friendly transportation goals</p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-xs text-muted-foreground">Use your points for discounts and exclusive offers from eco-conscious brands</p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t pt-10 mb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground">info@eyetrack.tech</p>
            <p className="text-sm text-muted-foreground mb-2">123 Vision Street</p>
          ...
          <div className="md:col-span-2 flex flex-col md:items-end justify-between">
            <div>
              <p className="text-xs text-muted-foreground mb-3">© 2025 EyeTrack Technologies. All rights reserved.</p>
